    ...
    return (
        ...
        >
            ...
            <div className='mt-[20px]  lg:mt-[60px] xl:mt-[100px] relative z-10 overflow-hidden'>
                <img src={banneImg} alt='bannerIng' className='hidden sm:block absolute z-10 bottom-0 left-1/2 -translate-x-1/2 w-[250px] lg:w-[400px] xl:w-[550px]' />
                ...
                <div className='flex flex-col sm:flex-row justify-between gap-[20px] w-full mt-[20px] sm:mt-[80px] xl:mb-[150px] relative z-[1]'>
                    <div>
                    ...
                    <div>
                        <div className='flex gap-[3px] items-center justify-start sm:justify-end'>
                            {[...Array(5)].map((_, index) => (
                                <IoIosStar key={index} className='text-[#FFFFFF] size-[16px] sm:size-[26px]' />
                            ))}
                        </div>
